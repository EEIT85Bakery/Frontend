...
// const reels = ref(['🐰', '🐰', '🐰']);
const reels = ref(['../../public/imgZip/Icon/FB.png', '../../public/imgZip/Icon/FB.png', '../../public/imgZip/Icon/FB.png']);
...
const getRandomSymbol = () => {
  ...
  const symbols = [
    '../../public/imgZip/Icon/FB.png',
    '../../public/imgZip/Icon/GOOGLE.png',
    '../../public/imgZip/Icon/FB.png',
    '../../public/imgZip/Icon/GOOGLE.png'
  ];
...
const determineResult = () => {
  ...
  // 獎勵結果：
  if (bigWin) {
    setReelsAndResult('../../public/imgZip/Icon/FB.png', 100);
  } else if (mediumWin) {
    setReelsAndResult('../../public/imgZip/Icon/GOOGLE.png', 50);
  } else if (smallWin) {
    setReelsAndResult('../../public/imgZip/Icon/FB.png', 30);
  } else {
    setReelsAndResult('../../public/imgZip/Icon/GOOGLE.png', 10);
  }
